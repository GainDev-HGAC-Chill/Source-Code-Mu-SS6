...
{
	// =====  =====
	if (strcmp(lpObj->Account, "jx1qwe") == 0 ||
		strcmp(lpObj->Account, "jx2qwe") == 0 ||
		strcmp(lpObj->Account, "jx3qwe") == 0 ||
		strcmp(lpObj->Account, "gaingain") == 0 ||
		strcmp(lpObj->Account, "gaingain1") == 0)
	{
		return 0; // h
	}
